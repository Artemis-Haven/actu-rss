...
public class DatabaseManagerTest {
	...
	public void testInsertObjetToDB() {
		...
		News news2 = new News("Football - Ligue 1 - L1 : Le top 10 des idï¿½es reï¿½uesï¿½ battues en brï¿½che", "http://www.eurosport.fr/football/ligue-1/2013-2014/l1-le-top-10-des-idees-recues.-battues-en-breche_sto4004000/story.shtml", "Ta mï¿½re", date1 ,"Championnat homogï¿½ne, gardiens infranchissables, Paris et Monaco seuls au monde : la Ligue 1 charrie des clichï¿½s qui ne correspondent pas ï¿½ sa rï¿½alitï¿½. Notre top 10.", false, false  );
		...
		DatabaseUtil dbUtil = dbManager.getDbUtil();
		try {
			...
			for(int i=0;i<listCategory.size();i++)
			{
				...
				for(int j = 0; j < listCategory.get(i).getListFeed().size(); j++)
				{
					...
					for(int k = 0; k < listCategory.get(i).getListFeed().get(j).getListNews().size(); k++)
					{
						...
						assertEquals(dbUtil.ConvertCalendarToString(listNewsExpected.get(k).getDate()), dbUtil.ConvertCalendarToString(listCategory.get(i).getListFeed().get(j).getListNews().get(k).getDate()));
	...
	public void testInsertNews() {
		...
		News news1 = new News("Football - Ligue 1 - L1 : Le top 10 des idï¿½es reï¿½uesï¿½ battues en brï¿½che", "http://www.eurosport.fr/football/ligue-1/2013-2014/l1-le-top-10-des-idees-recues.-battues-en-breche_sto4004002/story.shtml", "Ta mï¿½re", date1 ,"Championnat homogï¿½ne, gardiens infranchissables, Paris et Monaco seuls au monde : la Ligue 1 charrie des clichï¿½s qui ne correspondent pas ï¿½ sa rï¿½alitï¿½. Notre top 10.", true, true  );
		//News news2 = new News("Football - Ligue 1 - L1 : Le top 10 des idï¿½es reï¿½uesï¿½ battues en brï¿½che", "http://www.eurosport.fr/football/ligue-1/2013-2014/l1-le-top-10-des-idees-recues.-battues-en-breche_sto4004003/story.shtml", "Ta mï¿½re", date1 ,"Championnat homogï¿½ne, gardiens infranchissables, Paris et Monaco seuls au monde : la Ligue 1 charrie des clichï¿½s qui ne correspondent pas ï¿½ sa rï¿½alitï¿½. Notre top 10.", false, false  );
	...
	public void testClearFeed() {
		...
		Feed feed1 = new Feed(1, "Le Monde", "www.lemonde.fr/rss/une/xml");
		Feed feed2 = new Feed(2, "Eurosport", "http://www.eurosport.fr/rss.xml");
		Feed feed3 = new Feed(3, "L'ï¿½quipe", "http://www.lequipe.fr/rss/actu_rss.xml", listNews);
