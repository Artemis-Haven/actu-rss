 ...
 * Category Une categorie est determinee par un nom, et contient une liste de
 * feeds
 * 
...
public class Category {
	 ...
	 * @param url
	 *            l'url de la categorie
	 * @param listFeed
	 *            la liste des flux de la categorie
	 */
	...
	public Category(int id, String name) {
		this(id, name, new ArrayList<Feed>());
	}
	...
	public String toString() {
		 ...
		 * for(Feed f : this.getListFeed()) { resultat += "\n" + f; } return
		 * resultat;
		 */
		return this.getName();
	}
