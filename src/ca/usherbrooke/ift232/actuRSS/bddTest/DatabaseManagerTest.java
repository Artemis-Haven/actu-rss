...
public class DatabaseManagerTest {
	...
	public void testInsertObjetToDB() throws SQLException {
		...
		assertEquals(listCategoryExpected.size(), listCategoryBDD.size());
		assertEquals(listCategoryExpected.get(0).getListFeed().size(), listCategoryBDD.get(0).getListFeed().size());
		assertEquals(listCategoryExpected.get(0).getListFeed().get(0).getListNews().size(), listCategoryBDD.get(0).getListFeed().get(0).getListNews().size());
		...
		try {
			...
			assertEquals(listCategoryExpected.size(), listCategory.size());
