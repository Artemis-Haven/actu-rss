...
public class Controller implements ActionListener {
	...
	public Controller(Model model, View view) {
		...
		News n1 = new News(
				...
				"http://feed.macg.co/c/302/f/435189/s/34620909/sc/23/l/0L0Sigen0Bfr0Crumeurs0Csosh0Epas0Ede0Ehausse0Ede0Ela0Etva0E10A9158/story01.htm",
				"Christophe Laporte",
				new GregorianCalendar(),
				"Aux dernières nouvelles, Sosh ne répercuterait pas sur ses prix la hausse de la TVA qui doit intervenir le 1er janvier 2014. Il s’agit pour le moment d’un bruit de couloir, qui pourrait être confirmé dans la semaine. ",
				false, false);
		News n2 = new News(
				"Apple Store : des financements pour les entreprises",
				"http://feed.macg.co/c/302/f/435189/s/34628705/sc/23/l/0L0Smacg0Bco0C0Cmac0C20A130C120Capple0Estore0Edes0Efinancements0Epour0Eles0Eentreprises0E78495/story01.htm",
				"Christophe Laporte",
				new GregorianCalendar(),
				"Jusqu’à la fin de l’année, Apple propose deux formules pour permettre aux professionnels de louer ou acheter ses solutions à des conditions intéressantes.",
				false, false);

		News n3 = new News(
				"Une alternative à Time Machine",
				"http://www.macbidouille.com/news/2013/12/03/une-alternative-a-time-machine",
				"lionel@macbidouille.com (Lionel)",
				new GregorianCalendar(),
				"Time Machine a eu l'indéniable intérêt de sensibiliser le plus grand nombre à la sauvegarde et inciter l'essentiel des utilisateurs de Mac à s'y mettre enfin. Toutefois, si le système d'Apple est très simple d'utilisation, il manque de souplesse pour une utilisation plus professionnelle des sauvegardes. Un logiciel, Qrecall, va bien plus loin que ce que propose Apple (Merci Roderich).",
				false, false);
		News n4 = new News(
				"Un nouveau rachat de startup par Apple",
				"http://www.macbidouille.com/news/2013/12/03/un-nouveau-rachat-de-startup-par-apple",
				"lionel@macbidouille.com (Lionel)",
				new GregorianCalendar(),
		...
		News n5 = new News(
				...
				"http://korben.info/retrouver-le-mot-de-passe-perdu-dun-disque-dur-seagate.html",
				"Korben",
				new GregorianCalendar(),
				"Sur les disques durs Seagate, il est possible de mettre un mot de passe au niveau du firmware du disque afin de protéger l'accès. Mais le plus souvent, les gens l'oublient et malheureusement, Seagate ne souhaite pas toujours aider ceux qui sont en galère parce qu'ils ne peuvent prouver qu'ils sont bien les propriétaires du disque.",
				false, false);
		News n6 = new News(
				"OS X Mavericks : Boostez vos configurations pour en tirer le meilleur !",
				"http://korben.info/os-x-mavericks-boostez-vos-configurations-pour-en-tirer-le-meilleur.html",
				"Korben",
				new GregorianCalendar(),
				"Cet article fait partie d'une série sponsorisée sur OSX Mavericks et a été co-écrit avec Macway. Vous êtes éligible à la mise à jour vers OS X Mavericks et avez sauté le pas? Tant qu’à faire le changement, autant le faire de la meilleure des façons en redonnant un coup de « boost » à votre Mac ainsi qu’en l’accompagnant d’accessoires malins et pratiques. MacWay vous propose de découvrir des conseils et explications produits vous aidant à exploiter davantage votre ordinateur",
				false, false);

		News n7 = new News(
				"Dark Vador aussi aime se prendre en photo, la preuve",
				"http://www.presse-citron.net/dark-vador-aussi-aime-se-prendre-en-photo-la-preuve",
				"Axel Cereloz",
				new GregorianCalendar(),
				"Dark Vador a aussi ses petits élans de narcissisme, en témoigne cette image de 'selfie' publié sur le nouveau compte Instagram de Star Wars.",
				false, false);
		News n8 = new News(
				"[billet sponsorisé] Auchan Drive pour Android, faire ses courses sans courir",
				"http://www.presse-citron.net/billet-sponsorise-auchan-drive-pour-android-faire-ses-courses-sans-courir",
				"Eric",
				new GregorianCalendar(),
				"L'application Android Auchan Drive permet de faire ses courses sur son smartphone ou tablette et de retirer ensuite ses marchandises dans un Drive Auchan en quelques minutes.",
				false, false);
		News n9 = new News("Suce ma bite", "url", "Yann",
				new GregorianCalendar(), "ENCULER DE GAUTHIER ET VINCENT",
				false, false);
