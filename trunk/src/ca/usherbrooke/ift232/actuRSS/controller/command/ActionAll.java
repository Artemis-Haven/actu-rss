...
public class ActionAll extends AbstractAction {
	...
	public ActionAll(Filter theDisplayHook, Toolbar toolbarHook, ActuList newsListHook,List<News> newsHook, Sorter actualSorterHook)
	{
